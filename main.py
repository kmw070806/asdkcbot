...
async def on_message(message): # on_message() event : when the bot has recieved a message
    ...
    if message.content.startswith("안녕하세요"): #만약 내가 안녕하세요라고 보냈다면,
        await message.channel.send("안녕!!") #봇이 명령어 안녕!!을 보내줌
    if message.content.startswith("초대링크"):
        await message.channel.send("https://discordapp.com/api/oauth2/authorize?client_id=703948156903358554&permissions=8&scope=bot")
    if message.content.startswith("끄투코리아"):
        await message.channel.send("https://kkutu.co.kr/")    



client.run('NzAzOTQ4MTU2OTAzMzU4NTU0.XqWA1w.I-dLJUig37J73_VFdJrw7vfuTIo')